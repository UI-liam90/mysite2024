...
import { getContactDetails } from "../globalQueries";
import "./style.scss";

const contactDetailsGlobal = await getContactDetails();

const ContactBlock = ({ blockData }) => {
    const contactDetails = contactDetailsGlobal?.acfOptionsContactDetails?.contactDetails;
